...
export function ResumeBuilderPage() {
  ...
  const patchContent = useCallback((contentPatch) => {
    setResume((prev) => {
      const next = { ...prev, content: { ...prev.content, ...contentPatch } };
      resumeRef.current = next;
      return next;
    });
    scheduleAutosave();
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex gap-2 border-b border-border pb-3">
                {['content', 'design', 'sections', 'history'].map((tab) => (
                  <button
                    key={tab}
                    type="button"
            ...
            <CardContent>
              ...
              {activeTab === 'sections' && (
                <SortableSectionList
                  ...
                  onToggleVisibility={(id) => patchResume({
                    sectionVisibility: { ...resume.sectionVisibility, [id]: !resume.sectionVisibility[id] },
                  })}
                />
              )}
        ...
        <div className="xl:sticky xl:top-4 xl:self-start">
          <Card>
            ...
            <CardContent className="p-2 sm:p-4">
              <ResumePreview resume={resume} resumeId={resume.id} useLiveState />
            </CardContent>
          </Card>
        </div>
      </div>
